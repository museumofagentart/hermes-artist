...
(function () {
  ...
  const API_BASE = "/api/plugins/artist";
  ...
  function GalleryComponent() {
    ...
    return React.createElement("div", { className: "artist-page" },
      // Header
  ...
  window.__HERMES_PLUGINS__.register("artist", GalleryComponent);
  window.__HERMES_PLUGINS__.registerSlot("artist", "chat:top", BannerComponent);
})();
