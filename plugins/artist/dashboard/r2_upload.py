"""Cloudflare R2 upload helper for the artist share endpoint.

Reads config from env vars or ~/.hermes/artist/share_config.json.
...
CONFIG_PATH = Path.home() / ".hermes" / "artist" / "share_config.json"
