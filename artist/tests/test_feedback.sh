...
FEEDBACK_SCRIPT="$REPO_DIR/artist/scripts/feedback.sh"
...
assert_exit_code 0 "validate-meta.sh passes after set-favorite true" bash "$REPO_DIR/artist/scripts/validate-meta.sh" "$PIECE_DIR1/meta.json"
...
assert_exit_code 0 "validate-meta.sh passes after set-favorite false" bash "$REPO_DIR/artist/scripts/validate-meta.sh" "$PIECE_DIR1/meta.json"
...
assert_exit_code 0 "validate-meta.sh passes after idempotent favorite" bash "$REPO_DIR/artist/scripts/validate-meta.sh" "$PIECE_DIR1/meta.json"
...
assert_exit_code 0 "validate-meta.sh passes after set-discouraged true" bash "$REPO_DIR/artist/scripts/validate-meta.sh" "$PIECE_DIR1/meta.json"
...
assert_exit_code 0 "validate-meta.sh passes after comments" bash "$REPO_DIR/artist/scripts/validate-meta.sh" "$PIECE_DIR2/meta.json"
...
assert_exit_code 0 "validate-meta.sh passes after newline/tab comment" bash "$REPO_DIR/artist/scripts/validate-meta.sh" "$PIECE_DIR2/meta.json"
